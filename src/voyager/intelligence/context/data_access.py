...
class DataAccess:
    ...
    def get_macro_snapshot(self) -> Dict[str, Any]:
        ...
        """
        from voyager.intelligence.context.macro_adapter import build_macro_snapshot
    ...
    def get_regimes(self) -> Dict[str, str]:
        ...
        """
        from voyager.intelligence.context.macro_adapter import compute_regimes
