...
from voyager.memory.workflow import ObservationMemoryWorkflow, ObservationIngestContext
...
def build_context_for_text(
    ...
    """
    High-level helper for the Voyager Copilot / internal code:
