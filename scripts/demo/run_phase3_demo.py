...
from voyager.engine.analytics_pipeline import run_backtest_with_risk
from voyager.risk.schemas import RiskReport


def main() -> None:
    parser = argparse.ArgumentParser(description="Voyager Phase 3 demo runner")
    parser.add_argument(
        "--strategy-id",
        type=str,
