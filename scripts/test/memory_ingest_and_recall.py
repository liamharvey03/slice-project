...
from voyager.memory.api import build_context_for_text


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ingest an observation into Voyager memory and recall similar observations."
    )
    parser.add_argument(
        "text",
